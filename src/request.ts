...
export const localApiKey = LocalStored<string>("api_key", "")

function getApiKey(): string {
  let key = localApiKey
  if (!key.get()) key.set(prompt("provide openrouter key") || "")
  if (!key.get()) throw new Error("Missing OpenRouter API key")
  return key.get()!
}
